...
public class Camera : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        transform.position = new Vector3(Mathf.Clamp(posX,minimo.x,maximo.x), Mathf.Clamp(posY,minimo.y,maximo.y), transform.position.z);  //Pasamos la nueva posicion a la camara
    }
}
